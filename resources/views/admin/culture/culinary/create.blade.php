...
@section('title') Visit Denizli - Mutfak Kültürü Ekle @endsection
...
@section('content')
    ...
    <div class="px-md-4 px-2 py-2 page-header" data-bs-theme="none">
        <div class="d-flex align-items-center">
            ...
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page" title="App">Mutfak Kültürü Ekle</li>
            </ol>
        </div>
    ...
    <div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
        <h3 class="title-font mb-3">Mutfak Kültürü Ekle</h3>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                        ...
                        <form action="{{ route('admin.culinary.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Mutfak Kültürü Adı (TR)" value="{{ old('name') }}" required>
                                    @error('name')
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Mutfak Kültürü Adı (EN)" value="{{ old('name_en') }}">
                                    @error('name_en')
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
