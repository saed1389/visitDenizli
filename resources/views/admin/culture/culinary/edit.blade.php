...
@section('title') Visit Denizli - Mutfak Kültürü Güncelle @endsection
...
@section('content')
    ...
    <div class="px-md-4 px-2 py-2 page-header" data-bs-theme="none">
        <div class="d-flex align-items-center">
            ...
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.culinary.index') }}" >Mutfak Kültürü Listesi</a></li>
                <li class="breadcrumb-item active" aria-current="page" title="App">Mutfak Kültürü Güncelle</li>
            </ol>
        </div>
    ...
    <div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
        <h3 class="title-font mb-3">Mutfak Kültürü Güncelle</h3>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body card-main-one">
                        <form action="{{ route('admin.culinary.update', $culinary->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-sm-6">
                                    <label for="name" class="form-label"><strong>Mutfak Kültürü Adı (TR)<span class="text-danger">*</span></strong></label>
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Mutfak Kültürü Adı (TR)" value="{{ $culinary->name }}" required>
                                    @error('name')
                                ...
                                <div class="col-sm-6">
                                    <label for="name_en" class="form-label"><strong>Mutfak Kültürü Adı (EN)</strong></label>
                                    <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Mutfak Kültürü Adı (EN)" value="{{ $culinary->name_en }}">
                                    @error('name_en')
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
                                ...
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <textarea name="description" class="form-control" id="ckeditor_tr" >{{ $culinary->description }}</textarea>
                                    @error('description')
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
                                ...
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <textarea name="description_en" class="form-control" id="ckeditor_en" >{{ $culinary->description_en }}</textarea>
                                ...
                                <div class="col-sm-2 mt-3">
                                    <img src="{{ $culinary->image ? asset($culinary->image) : asset('panel/assets/images/def.png') }}" id="showImage" class="img-thumbnail" alt="" >
                                </div>
                                ...
                                <div class="col-sm-2 mt-3">
                                    <img src="{{ $culinary->banner_image ? asset($culinary->banner_image) : asset('panel/assets/images/def.png') }}" id="showBannerImage" class="img-thumbnail" alt="" >
                                </div>

                                <div class="col-sm-3 mt-3">
                                    <label for="status" class="form-label"><strong>Durum</strong></label>
                                    <div class="my-3">
                                        <input id="active" name="status" type="radio" value="1" class="form-check-input" @checked($culinary->status == 1)>
                                        <label class="form-check-label" for="active">Acik</label>
                                        <input id="deactivate" name="status" type="radio" value="0" class="form-check-input" @checked($culinary->status == 0)>
                                ...
                                <div class="col-12 text-end">
                                    <a href="{{ route('admin.culinary.index') }}" class="btn btn-outline-secondary">İptal</a>
                ...
                upload() {
                    return this.loader.file
                        .then(file => new Promise((resolve, reject) => {
                            ...
                            fetch("{{ route('admin.culinary.upload') }}", {
                                method: 'POST',
                                headers: {
