...
@section('title') Visit Denizli - Gelenek ve Görenek Güncelle @endsection
...
@section('content')
    ...
    <div class="px-md-4 px-2 py-2 page-header" data-bs-theme="none">
        <div class="d-flex align-items-center">
            ...
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.traditions.index') }}" >Gelenek ve Görenekler Listesi</a></li>
                <li class="breadcrumb-item active" aria-current="page" title="App">Gelenek ve Görenek Güncelle</li>
            </ol>
        </div>
    ...
    <div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
        <h3 class="title-font mb-3">Gelenek ve Görenek Güncelle</h3>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body card-main-one">
                        <form action="{{ route('admin.traditions.update', $tradition->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-sm-4">
                                    <label for="name" class="form-label"><strong>Gelenek ve Görenek Adı (TR)<span class="text-danger">*</span></strong></label>
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Gelenek ve Görenek Adı (TR)" value="{{ $tradition->name }}" required>
                                    @error('name')
                                ...
                                <div class="col-sm-4">
                                    <label for="name_en" class="form-label"><strong>Gelenek ve Görenek Adı (EN)</strong></label>
                                    <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Gelenek ve Görenek Adı (EN)" value="{{ $tradition->name_en }}">
                                    @error('name_en')
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-select" name="county_id" id="county_id" required >
                                        ...
                                        @foreach($counties as $county)
                                            <option value="{{ $county->id }}" @selected($tradition->county_id == $county->id)>{{ $county->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('county_id')
                                    <span class="text-danger">
                                ...
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <textarea name="description" class="form-control" id="ckeditor_tr" >{{ $tradition->description }}</textarea>
                                    @error('description')
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
                                ...
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <textarea name="description_en" class="form-control" id="ckeditor_en" >{{ $tradition->description_en }}</textarea>
                                ...
                                <div class="col-sm-2 mt-3">
                                    <img src="{{ $tradition->image ? asset($tradition->image) : asset('panel/assets/images/def.png') }}" id="showImage" class="img-thumbnail" alt="" >
                                </div>
                                ...
                                <div class="col-sm-2 mt-3">
                                    <img src="{{ $tradition->banner_image ? asset($tradition->banner_image) : asset('panel/assets/images/def.png') }}" id="showBannerImage" class="img-thumbnail" alt="" >
                                </div>

                                <div class="col-sm-3 mt-3">
                                    <label for="status" class="form-label"><strong>Durum</strong></label>
                                    <div class="my-3">
                                        <input id="active" name="status" type="radio" value="1" class="form-check-input" @checked($tradition->status == 1)>
                                        <label class="form-check-label" for="active">Acik</label>
                                        <input id="deactivate" name="status" type="radio" value="0" class="form-check-input" @checked($tradition->status == 0)>
                                ...
                                <div class="col-12 text-end">
                                    <a href="{{ route('admin.traditions.index') }}" class="btn btn-outline-secondary">İptal</a>
                ...
                upload() {
                    return this.loader.file
                        .then(file => new Promise((resolve, reject) => {
                            ...
                            fetch("{{ route('admin.traditions.upload') }}", {
                                method: 'POST',
                                headers: {
