    ...
    <div class="px-md-4 px-2 py-2 page-header" data-bs-theme="none">
        <div class="d-flex align-items-center">
            ...
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.government.index') }}" >Yerel Yönetim Listesi</a></li>
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body card-main-one">
                        <form action="{{ route('admin.government.update', $government->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-select" name="county_id" id="county_id" >
                                        <option value="">-- Lütfen Seçin --</option>
                                        @foreach($counties as $county)
                                            <option value="{{ $county->id }}" @selected($government->county_id == $county->id)>{{ $county->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('county_id')
                                    <span class="text-danger">
                                ...
                                <div class="col-sm-3 mt-3">
                                    ...
                                    <div class="my-3">
                                        <input id="active" name="status" type="radio" value="1" class="form-check-input" @checked($government->status == 1 )>
                                        <label class="form-check-label" for="active">Acik</label>
                                        <input id="deactivate" name="status" type="radio" value="0" class="form-check-input" @checked($government->status == 0 )>
                                ...
                                <div class="col-12 text-end">
                                    <a href="{{ route('admin.government.index') }}" class="btn btn-outline-secondary">İptal</a>
