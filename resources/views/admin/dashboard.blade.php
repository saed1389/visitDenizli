...
@section('content')
    ...
    <div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
        <ul class="row g-2 list-unstyled li_animate row-cols-lg-3 row-cols-md-3 row-cols-sm-2 row-cols-2 row-deck mb-lg-5 mb-4">
            <li class="col">
                <a class="card hr-arrow p-4" href="{{ route('admin.news.index') }}" title="" style="--dynamic-color: var(--theme-color1);">
            ...
            <li class="col">
                <a class="card hr-arrow p-4" href="{{ route('admin.events.index') }}" title="" style="--dynamic-color: var(--theme-color5);">
                    <svg class="mb-3" width="20" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
