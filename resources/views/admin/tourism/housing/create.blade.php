            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body card-main-one">
                        <form action="{{ route('admin.housing.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-4 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Konaklama Telefoni" value="{{ old('phone') }}">
                                    @error('phone')
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
