                        ...
                        {{--<table class="myDataTable table table-hover table-bordered align-middle mb-0" style="width:100%">
                            ...
                            @foreach($offices as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.tourism-office.edit', $item->id) }}" class="btn btn-info btn-sm mt-1"><i class="fa fa-edit"></i></a>
                                        <button type="button" href="{{ route('admin.tourism-office.destroy', $item->id) }}" class="btn btn-danger btn-sm mt-1" id="delete"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
