...
@section('title') Visit Denizli - Yatırım Fırsat Ekle @endsection
...
@section('content')
    ...
    <div class="px-md-4 px-2 py-2 page-header" data-bs-theme="none">
        <div class="d-flex align-items-center">
            ...
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page" title="App">Yatırım Fırsat Ekle</li>
            </ol>
        </div>
    ...
    <div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
        <h3 class="title-font mb-3">Yatırım Fırsat Ekle</h3>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                        ...
                        <form action="{{ route('admin.investment.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Yatırım Fırsat Adı (TR)" value="{{ old('name') }}" required>
                                    @error('name')
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Yatırım Fırsat Adı (EN)" value="{{ old('name_en') }}" >
                                    @error('name_en')
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
                                ...
                                <div class="col-12 text-end">
                                    <a href="{{ route('admin.investment.index') }}" class="btn btn-outline-secondary">İptal</a>
