...
@section('title') Visit Denizli - Yerel Ekonomi ve Sektör Güncelle @endsection
...
@section('content')
    ...
    <div class="px-md-4 px-2 py-2 page-header" data-bs-theme="none">
        <div class="d-flex align-items-center">
            ...
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page" title="App">Yerel Ekonomi ve Sektör Güncelle</li>
            </ol>
        </div>
    ...
    <div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
        <h3 class="title-font mb-3">Yerel Ekonomi ve Sektör Güncelle</h3>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                        ...
                        <form action="{{ route('admin.industries.update', $industry->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Sektör Adı " value="{{ $industry->name }}" required>
                                    @error('name')
                                ...
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <textarea name="description" class="form-control" id="ckeditor_tr" required >{{ $industry->description }}</textarea>
                                    @error('description')
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
                                ...
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <textarea name="description_en" class="form-control" id="ckeditor_en" >{{ $industry->description_en }}</textarea>
                                ...
                                <div class="col-sm-3 mt-3">
                                    <img src="{{ $industry->image ? asset($industry->image) : asset('panel/assets/images/def.png') }}" id="showImage" class="img-thumbnail" alt="" >
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <label for="status" class="form-label"><strong>Durum</strong></label>
                                    <div class="my-3">
                                        <input id="active" name="status" type="radio" value="1" class="form-check-input" @checked($industry->status == 1 )>
                                        <label class="form-check-label" for="active">Acik</label>
                                        <input id="deactivate" name="status" type="radio" value="0" class="form-check-input" @checked($industry->status == 0 )>
