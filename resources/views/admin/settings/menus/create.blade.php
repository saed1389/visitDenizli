                        ...
                        <form action="{{ route('admin.menu.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Menü Başlığı (TR) " value="{{ old('title') }}" required>
                                    @error('title')
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" id="title_en" name="title_en" placeholder="Menü Başlığı (EN) " value="{{ old('title_en') }}" >
                                    @error('title_en')
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-select" name="parent_id" id="parent_id" required>
                                        ...
                                        <option value="2">Gezilecek Yerler</option>
                                        <option value="3">Kültür ve Sanat</option>
                                        <option value="4">Etkinlikler ve Haberler</option>
                                        <option value="5">Turizm</option>
                                        <option value="6">İş ve Ekonomi</option>
                                        <option value="7">Fotoğraf ve Video Galeri</option>
                                        <option value="8">Harita ve Ulaşım</option>
                                        <option value="9">İletişim</option>
                                    </select>
                                    @error('parent_id')
                                    <span class="text-danger">
                                        {{ $message }}
