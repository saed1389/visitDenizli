...
@section('title') Visit Denizli - Kullanıcı Yönetim @endsection
    ...
    <div class="px-md-4 px-2 py-2 page-header" data-bs-theme="none">
        <div class="d-flex align-items-center">
            ...
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page" title="App">Kullanıcı Yönetim</li>
            </ol>
        </div>
            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-header py-3 d-flex flex-wrap justify-content-between align-items-center bg-transparent border-bottom-0">
                        <h4 class="card-title m-0">Kullanıcı Yönetim</h4>
                        <div class="form-check form-switch table-toggle-three">
                            <a href="{{ route('admin.user.create') }}" class="btn btn-secondary" >Kullanıcı Ekle</a>
                        </div>
                    </div>
                        ...
                        <table class="myDataTable table table-hover table-bordered align-middle mb-0" style="width:100%">
                            ...
                            @foreach($users as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.user.edit', $item->id) }}" class="btn btn-info btn-sm mt-1"><i class="fa fa-edit"></i></a>
                                        <button type="button" href="{{ route('admin.user.destroy', $item->id) }}" class="btn btn-danger btn-sm mt-1" id="delete"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
        ...
        $(document).ready(function(){
            $(document).on('change', '.switch-input.active', function() {
                ...
                $.ajax({
                    ...
                    url: "/admin/user/changeStatus/" + check_id + "/" + check_active,
