                ...
                <div class="tab-content mt-3">
                    <div class="tab-pane fade show active" id="pills_today" role="tabpanel">
                        <ul class="row g-4 list-unstyled li_animate mb-0 trending-blog">
                            {{--@php
                                $lastUsers = \App\Models\User::where('type', 0)->orderBy('created_at', 'desc')->take(10)->get();
                            @endphp
                                ...
                                <li class="col-12 d-flex align-items-start">
                                    ...
                                    <div class="text-truncate ms-2 ps-3 border-start dashed border-0">
											<span class="d-flex align-items-center mb-3">
												<img class="avatar sm rounded-circle border border-3 me-2" src="{{ $user->gender == 1 ? asset('panel/assets/images/xs/avatar1.jpg') : asset('panel/assets/images/xs/avatar5.jpg') }}" alt="avatar">
												{{ $user->name }}
											</span>
                                        <div class="d-flex align-items-center text-muted small">
                                            <span class="pe-3">{{ ($user->created_at) }}</span>
                                        </div>
                                    </div>
                                </li>
                            @endforeach--}}
