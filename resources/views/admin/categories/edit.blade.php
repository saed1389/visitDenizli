    ...
    <div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
        <div class="row g-3">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-header py-3 d-flex flex-wrap justify-content-between align-items-center bg-transparent border-bottom-0">
                        <h4 class="card-title m-0">Kategori Güncelle</h4>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Kategori adı (TR)" value="{{ $category->name }}" required>
                                    @error('name')
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Kategori adı (EN)" value="{{ $category->name_en }}" >
                                    @error('name_en')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <textarea class="form-control" name="description" id="ckeditor_tr" rows="3">{{ $category->description }}</textarea>
                                    @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <textarea class="form-control" name="description_en" id="ckeditor_en" rows="3">{{ $category->description_en }}</textarea>
                                ...
                                <div class="col-sm-8 mt-3">
                                    ...
                                    <input type="color" class="form-control-color" id="color" name="color" placeholder="" value="{{ $category->color }}">
                                    @error('color')
                                ...
                                <div class="col-sm-4 mt-3">
                                    <img src="{{ $category->image ? asset($category->image) : asset('panel/assets/images/def.png') }}" id="showImage" class="img-thumbnail" alt="" >
                                </div>
                                ...
                                <div class="col-sm-4 mt-3">
                                    <img src="{{ $category->icon ? asset($category->icon) : asset('front/assets/images/def-loc.png') }}" id="showIcon" class="img-thumbnail" alt="" >
                                </div>
                                <div class="col-sm-12 mt-3">
                                    <label for="status" class="form-label"><strong>Durum</strong></label>
                                    <div class="my-3">
                                        <input id="active" name="status" type="radio" value="1" class="form-check-input" @checked($category->status == 1) required="">
                                        <label class="form-check-label" for="active">Açik</label>
                                        <input id="deactivate" name="status" type="radio" value="0" class="form-check-input" @checked($category->status == 0) required="">
            ...
            upload() {
                return this.loader.file
                    .then(file => new Promise((resolve, reject) => {
                        ...
                        fetch("{{ route('admin.counties.ckeditor.upload') }}", {
                            method: 'POST',
                            headers: {
