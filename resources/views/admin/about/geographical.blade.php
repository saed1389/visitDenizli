...
@section('title') Visit Denizli - Coğrafi Bilgiler @endsection
    ...
    <div class="px-md-4 px-2 py-2 page-header" data-bs-theme="none">
        <div class="d-flex align-items-center">
            ...
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page" title="App">Coğrafi Bilgiler</li>
            </ol>
        </div>
            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-header py-3 d-flex flex-wrap justify-content-between align-items-center bg-transparent border-bottom-0">
                        <h4 class="card-title m-0">Coğrafi Bilgiler</h4>
                    </div>
                    <form action="{{ route('admin.about.geographical-update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6 ">
                                    <label for="ckeditor_tr" class="form-label"><strong>Coğrafi Bilgiler (TR) <span class="text-danger">*</span></strong></label>
                                    <textarea class="form-control" name="geographical" id="ckeditor_tr" rows="3">{{ @$about->geographical }}</textarea>
                                    @error('geographical')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-sm-6">
                                    <label for="ckeditor" class="form-label"><strong>Coğrafi Bilgiler (EN)</strong></label>
                                    <textarea class="form-control" name="geographical_en" id="ckeditor_en" rows="3">{{ @$about->geographical_en }}</textarea>
                                    @error('geographical_en')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-4 mt-3">
                                        <img src="{{ @$about->g_image ? asset(@$about->g_image) : asset('panel/assets/images/def.png') }}" id="showImage" class="img-thumbnail" alt="" >
                                    </div>
                                </div>
