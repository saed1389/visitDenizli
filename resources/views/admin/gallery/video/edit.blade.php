    ...
    <div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
        <div class="row g-3">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-header py-3 d-flex flex-wrap justify-content-between align-items-center bg-transparent border-bottom-0">
                        <h4 class="card-title m-0">Video Güncelle</h4>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Video Adı (TR)" value="{{ $video->name }}" required>
                                    @error('name')
                                ...
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Video Adı (EN)" value="{{ $video->name_en }}" >
                                    @error('name_en')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="link" name="link" placeholder="Video Linki" value="{{ $video->link }}" >
                                    @error('link')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <div class="my-3">
                                        <input id="active" name="status" type="radio" value="1" class="form-check-input" @checked($video->status == 1)>
                                        <label class="form-check-label" for="active">Açik</label>
                                        <input id="deactivate" name="status" type="radio" value="0" class="form-check-input" @checked($video->status == 0)>
