    ...
    <div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
        <div class="row g-3">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-header py-3 d-flex flex-wrap justify-content-between align-items-center bg-transparent border-bottom-0">
                        <h4 class="card-title m-0">Resim Güncelle</h4>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Fotoğraf Adı (TR)" value="{{ $photo->name }}" required>
                                    @error('name')
                                ...
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Fotoğraf Adı (EN)" value="{{ $photo->name_en }}" >
                                    @error('name_en')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
