...
@section('title') Visit Denizli - Doğal Güzellikler @endsection
    ...
    <div class="px-md-4 px-2 py-2 page-header" data-bs-theme="none">
        <div class="d-flex align-items-center">
            ...
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page" title="App">Doğal Güzellikler</li>
            </ol>
        </div>
            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-header py-3 d-flex flex-wrap justify-content-between align-items-center bg-transparent border-bottom-0">
                        <h4 class="card-title m-0">Doğal Güzellikler</h4>
                        <div class="form-check form-switch table-toggle-three">
                            <a href="{{ route('admin.natural-places.create') }}" class="btn btn-secondary" >Doğal Güzellik Ekle</a>
                        </div>
                    </div>
        ...
        $(document).ready(function(){
            $(document).on('change', '.switch-input.active', function() {
                ...
                $.ajax({
                    ...
                    url: "/admin/natural-places/changeStatus/" + check_id + "/" + check_active,
