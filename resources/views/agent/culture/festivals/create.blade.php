...
@section('title') Visit Denizli - Yerel Festival Ekle @endsection
...
@section('content')
    ...
    <div class="px-md-4 px-2 py-2 page-header" data-bs-theme="none">
        <div class="d-flex align-items-center">
            ...
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page" title="App">Yerel Festival Ekle</li>
            </ol>
        </div>
    ...
    <div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
        <h3 class="title-font mb-3">Yerel Festival Ekle</h3>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body card-main-one">
                        <form action="{{ route('agent.local-festivals.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-4">
                                    <label for="name" class="form-label"><strong>Festival Adı (TR)<span class="text-danger">*</span></strong></label>
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Festival Adı (TR)" value="{{ old('name') }}" required>
                                    @error('name')
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Festival Adı (EN)" value="{{ old('name_en') }}">
                                    @error('name_en')
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
                                ...
                                <div class="col-sm-6 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="latitude" name="latitude" placeholder="Festival Enlem " value="{{ old('latitude') }}" >
                                    @error('latitude')
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
                                ...
                                <div class="col-sm-6 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="longitude" name="longitude" placeholder="Festival Boylam " value="{{ old('longitude') }}">
                                    @error('longitude')
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
