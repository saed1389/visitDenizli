    ...
    <div class="px-md-4 px-2 py-2 page-header" data-bs-theme="none">
        <div class="d-flex align-items-center">
            ...
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('agent.news.index') }}" >Haberler Listesi</a></li>
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body card-main-one">
                        <form action="{{ route('agent.news.update', $news->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-sm-4">
                                ...
                                <div class="col-12 text-end">
                                    <a href="{{ route('agent.news.index') }}" class="btn btn-outline-secondary">İptal</a>
