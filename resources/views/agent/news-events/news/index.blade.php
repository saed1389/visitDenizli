                ...
                <div class="card mb-3">
                    <div class="card-header py-3 d-flex flex-wrap justify-content-between align-items-center bg-transparent border-bottom-0">
                        ...
                        <div class="form-check form-switch table-toggle-three">
                            <a href="{{ route('agent.news.create') }}" class="btn btn-secondary" >Haber Ekle</a>
                        </div>
                    </div>
                        ...
                        <table class="myDataTable table table-hover table-bordered align-middle mb-0" style="width:100%">
                            ...
                            @foreach($news as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('agent.news.edit', $item->id) }}" class="btn btn-info btn-sm mt-1"><i class="fa fa-edit"></i></a>
                                        <button type="button" href="{{ route('agent.news.destroy', $item->id) }}" class="btn btn-danger btn-sm mt-1" id="delete"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
