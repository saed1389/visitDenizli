...
@section('title') Visit Denizli - Konaklama Rehberi @endsection
    ...
    <div class="px-md-4 px-2 py-2 page-header" data-bs-theme="none">
        <div class="d-flex align-items-center">
            ...
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page" title="App">Konaklama Rehberi</li>
            </ol>
        </div>
            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-header py-3 d-flex flex-wrap justify-content-between align-items-center bg-transparent border-bottom-0">
                        <h4 class="card-title m-0">Konaklama Rehberi</h4>
                        <div class="form-check form-switch table-toggle-three">
                            <a href="{{ route('agent.housing.create') }}" class="btn btn-secondary" >Konaklama Ekle</a>
                        </div>
                    </div>
                        ...
                        <table class="myDataTable table table-hover table-bordered align-middle mb-0" style="width:100%">
                            ...
                            @foreach($housings as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('agent.housing.edit', $item->id) }}" class="btn btn-info btn-sm mt-1"><i class="fa fa-edit"></i></a>
                                        <button type="button" href="{{ route('agent.housing.destroy', $item->id) }}" class="btn btn-danger btn-sm mt-1" id="delete"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
