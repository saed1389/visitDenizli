                ...
                <div class="col-lg-6 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ $menu }}">@if($type == 'historical') {{ __('pages.historical') }} @elseif($type == 'natural') {{ __('pages.natural') }} @elseif($type == 'museum') {{ __('pages.museum') }} @endif</a></li>
