<div>
    ...
    @endpush
    <main>
        <section class="banner bg-holder bg-overlay-black-50" style="background-image: url({{ asset($setting->slider) }});" aria-label="Discover Denizli">
            <div class="container">
        ...
        <section class="py-4 border-bottom" aria-label="Browse categories">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="owl-carousel" data-nav-dots="false" data-nav-arrow="false" data-items="6" data-md-items="5" data-sm-items="4" data-xs-items="2" data-xx-items="1" data-space="20" data-autoheight="false">
                            @foreach($categories as $category)
                                <div class="item">
                                    <a class="category-item bg-holder bg-overlay-black-50 text-center" style="background-image: url('/{{ $category->image }}'); height: 75px" href="{{ route('housing.by.category', $category->slug) }}" aria-label="{{ app()->getLocale() == 'tr' ? $category->name : $category->name_en }}">
        ...
        <section class="space-ptb" aria-label="Popular cities in Denizli">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                    ...
                    @foreach($cities as $city)
                        ...
                        <div class="{{ $columnClass }} {{ $marginClass }} mt-4">
                            <a href="{{ route('counties.detail', ['placeSlug' => $city->slug]) }}">
                                <div class="location-item bg-holder bg-overlay-black-50 text-center" style="background-image: url({{ $city->image }});" aria-label="{{ $city->name }}"></div>
                            </a>
        ...
        <section class="space-pb popup-gallery" aria-label="Latest blogs">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            <div class="listing-item">
                                <div class="listing-image bg-overlay-half-bottom">
                                    <img class="img-fluid" src="{{ $blog->image }}" alt="{{ app()->getLocale() == 'tr' ? $blog->name : $blog->name_en }} - Visit Denizli Blog" loading="lazy">
                                </div>
        ...
        <section class="space-pb" aria-label="About Visit Denizli">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 offset-lg-1 text-center">
                        <img class="img-fluid" src="{{ asset('front/assets/images/about/hakkimizda.png') }}" alt="About Visit Denizli" loading="lazy">
                    </div>
                </div>
            </div>
        </section>
        <section class="space-pb" aria-label="News and events">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
        ...
        <section class="space-pb" aria-label="Download our app">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5 mb-4 mb-lg-0 text-center">
                        <img class="img-fluid" src="{{ asset('front/assets/images/app.png') }}" alt="Visit Denizli Mobile App" loading="lazy">
                    </div>
