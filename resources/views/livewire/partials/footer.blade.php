            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="footer-contact-info">
                        <a href="/"><img class="img-fluid footer-logo" src="{{ asset($setting->logo) }}" alt="{{ $setting->site_name }}"></a>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6  mb-4 mb-lg-0">
                    <h5 class="text-primary mb-2 mb-sm-4">{{ __('footer.Locations') }}</h5>
                    <div class="footer-link">
                        <ul class="list-unstyled mb-0">
                            @foreach($popularCounties->take(5) as $county)
                                <li>
                                    <a href="{{ route('counties.detail', ['placeSlug' => $county->slug]) }}">{{ $county->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                        <ul class="list-unstyled mb-0">
                            @foreach($popularCounties->slice(5)->take(5) as $county)
                                <li>
                                    <a href="{{ route('counties.detail', ['placeSlug' => $county->slug]) }}">{{ $county->name }}</a>
                                </li>
                            @endforeach
                        ...
                        <ul class="list-unstyled mb-0">
                            @foreach($popularCounties->slice(10)->take(5) as $county)
                                <li>
                                    <a href="{{ route('counties.detail', ['placeSlug' => $county->slug]) }}">{{ $county->name }}</a>
                                </li>
                            @endforeach
                        ...
                        <ul class="list-unstyled mb-0">
                            @foreach($popularCounties->slice(15)->take(5) as $county)
                                <li>
                                    <a href="{{ route('counties.detail', ['placeSlug' => $county->slug]) }}">{{ $county->name }}</a>
                                </li>
                            @endforeach
