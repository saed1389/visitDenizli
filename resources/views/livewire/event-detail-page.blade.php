                ...
                <div class="col-lg-4">
                    <div class="blog-sidebar sidebar">
                        ...
                        @if($place->ticket_link)
                                <div class="widget">
                                    <div class="widget-title bg-primary">
                                        <h6 class="text-white mb-0"> <i class="fas fa-ticket-alt"></i> {{ __('pages.Buy Ticket Link') }} </h6>
                                    </div>
                                    <div class="widget-content">
                                        <i class="fa fa-link"> <a href="{{ $place->ticket_link }}" target="_blank">{{ $place->ticket_link }}</a></i>
                                    </div>
                                </div>
                        @endif
