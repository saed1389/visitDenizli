...
class EventController extends Controller
{
    ...
    {
        $events = Event::where('county_id', Auth::user()->county->id)->orderBy('created_at', 'asc')->get();
        return view('agent.news-events.events.index', compact('events'));
    }
    ...
    public function create()
    {
        ...
        return view('agent.news-events.events.create', compact('counties'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('agent.news-events.events.edit', compact('counties', 'event'));
    }
