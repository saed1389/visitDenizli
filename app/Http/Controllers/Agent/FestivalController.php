...
class FestivalController extends Controller
{
    ...
    {
        $festivals = Festival::where('county_id', Auth::user()->county_id)->orderBy('created_at', 'asc')->get();
        return view('agent.culture.festivals.index', compact('festivals'));
    }
    ...
    public function create()
    {
        ...
        return view('agent.culture.festivals.create', compact('counties'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agent.local-festivals.index');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('agent.culture.festivals.edit', compact('counties', 'festival'));
    }
