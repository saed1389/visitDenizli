...
class HistoryPlaceDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('county_id', function (HistoryPlace $place) {
     ...
     */
    public function query(HistoryPlace $model): QueryBuilder
    {
    ...
    {
        return 'HistoryPlace_' . date('YmdHis');
    }
}
